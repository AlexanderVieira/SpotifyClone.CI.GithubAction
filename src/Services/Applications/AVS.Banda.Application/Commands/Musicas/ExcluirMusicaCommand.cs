...
{
    public class ExcluirMusicaCommand : Comando
    {
        public MusicaRequestDto MusicaRequest { get; set; }

        public ExcluirMusicaCommand(MusicaRequestDto musicaRequest)
        {
        ...
        {
            ValidationResult = new ExcluirMusicaValidator().Validate(this);
            return ValidationResult.IsValid;
        }
    }

    public class ExcluirMusicaValidator : AbstractValidator<ExcluirMusicaCommand>
    {
        public ExcluirMusicaValidator()
        {
